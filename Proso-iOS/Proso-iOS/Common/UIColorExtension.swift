...
extension UIColor {
    ...
    static let firstNaturalColor = UIColor(red: 0.07, green: 0.07, blue: 0.07, alpha: 1.00)
    static let secondNaturalColor = UIColor(red: 0.40, green: 0.40, blue: 0.40, alpha: 1.00)
    static let thirdNaturalColor = UIColor(red: 0.60, green: 0.60, blue: 0.60, alpha: 1.00)
}
